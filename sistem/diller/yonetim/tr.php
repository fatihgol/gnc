...
$dil['ornek'] = 'Örnek:';
$dil['resim'] = 'Resim';
$dil['buyuk_resim'] = 'Büyük resim';
$dil['kucuk_resim'] = 'Küçük resim';
$dil['eposta'] = 'ePosta';
...
$dil['menu']['cache-temizle']		= 'Cache temizle';
...
$dil['menu']['veritabani_yedekle']	= 'Veritabanını yedekle';
...
$dil['yonetim_sayfasi_aciklama'] = '';
...
$dil['sosyal_ag_ayarlari'] = 'Sosyal ağ ayarları';
...
$dil['bakimda'] = 'Bakım modu';
$dil['modal_box_width'] = 'Modal penceresinin genişliği';
// Genel ayarlar
...
$dil['kripto_anahtari'] = 'Kripto anahtarı';
// Bölgesel ayarlar
...
$dil['smtp_host_1'] = 'SMTP Ana Sunucusu';
$dil['smtp_host_2'] = 'SMTP Yedek Sunucusu';
$dil['smtp_username'] = 'SMTP Kullanıcı Adı';
$dil['smtp_password'] = 'SMTP Şifresi';
$dil['smtp_secure'] = 'SMTP Güvenliği';
...
// Sosyal ağ ayarları
$dil['facebook_appid'] = 'Facebook app id';
$dil['facebook_secret'] = 'Facebook secret';
$dil['facebook_sayfasi'] = 'Facebook sayfası';
$dil['twitter_sayfasi'] = 'Twitter sayfası';
$dil['linkedin_sayfasi'] = 'Linkedin sayfası';
$dil['google_sayfasi'] = 'Google sayfası';
$dil['youtube_sayfasi'] = 'Youtube sayfası';
...
$dil['kullanıcı_aktif'] = 'Kullanıcı aktif';
$dil['yetki'] = 'Yetki';
...
// CKfinder file upload
$dil['selectedFile'] = 'Dosya seçildi';
$dil['file_Url'] = 'Dosya adresi';
$dil['file_Size'] = 'Dosya boyutu';
$dil['file_Date'] = 'Yükleme tarihi';
// Cache
$dil['cache'] = 'Cache';
...
$dil['cache_klasoru_temizlendi'] = 'Cache klasörü temizlendi.';
// Yönlendiriciler
...
$dil['yeni_kategori_kullanici_yetkilendirme_bilgi'] = 'Kategori ve kategori içerisindeki içeriği düzenlemeye yetkili olan yönetici yetkilerini belirleyin';
// Yeni kategori
...
// Veribanı yedekleme
$dil['veritabani_yedeklendi'] = 'Veritabanı başarıyla yedeklenmiştir.';
