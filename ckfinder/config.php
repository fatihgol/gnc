...
//require_once(str_replace('ckfinder/core/connector/php/connector.php', '', $_SERVER['SCRIPT_FILENAME']).'sistem/ayarlar.php');
$baseUrl = '/gnc/veri/';
